...
NAME="usacdata"                                  # Name of the application
ROOTDIR=/opt/webapps
...
DJANGO_SETTINGS_MODULE=usacdata.settings.main             # which settings file should Django use
DJANGO_WSGI_MODULE=usacdata.wsgi                     # WSGI module name
...
export PYTHONPATH=$DJANGODIR/usacdata:$PYTHONPATH
