# Generated by Django 2.0 on 2017-12-28 14:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lap1', models.CharField(blank=True, max_length=255, null=True)),
                ('lap2', models.CharField(blank=True, max_length=255, null=True)),
                ('lap3', models.CharField(blank=True, max_length=255, null=True)),
                ('lap4', models.CharField(blank=True, max_length=255, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Participant',
